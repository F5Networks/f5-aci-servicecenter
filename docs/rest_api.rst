...
| Request Body       | {                                                                       |
|                    |                                                                         |
|                    | "url": “<BIG-IP IP or IP:port or hostname or hostname:port>",           |
|                    |                                                                         |
|                    | "tenant": "<tenant_name>,                                               |
|                    |                                                                         |
...
| Success Response   | Code: 200                                                               |
|                    |                                                                         |
|                    | Content: “EPG mappings sync from APIC to BIG-IP successful"             |
|                    |                                                                         |
+--------------------+-------------------------------------------------------------------------+
| Error Response     | Code: 400                                                               |
|                    |                                                                         |
...
+--------------------+-------------------------------------------------------------------------+
| Title              | Get service discovery pool endpoints from BIG-IP                        |
+====================+=========================================================================+
